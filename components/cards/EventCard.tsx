        ...
        >
            <Box display={{ base: 'none', lg: 'flex' }} width="100%"
                ...
                <Image
                    ...
                    src={getUrlImage(event?.photos[0]?.url.replace('https://playitright.s3-ap-southeast-1.amazonaws.com/', 'https://quocbcx-1c878.kxcdn.com/') + '?width=550&quality=100&format=webp' ?? '/placeholder.png')}
